...
| --- | --- | --- | --- |
| **Immersive Commons** | Official hackathon status, team, capability, and submission-contract reads during coordination and monitoring. | Project record: [`API_ACCESS.md`](./API_ACCESS.md) and [`COORDINATION.md`](../COORDINATION.md). | Event operations only. Atlas did not submit, overwrite a submission, create an account, or send an event write. |
