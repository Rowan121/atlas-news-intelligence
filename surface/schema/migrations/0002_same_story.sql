...
ALTER TABLE articles ADD COLUMN same_story_json TEXT NOT NULL DEFAULT '{"publisherOrigin":{"status":"unknown","value":null,"confidence":null,"method":"unavailable","evidence":[],"reason":"Legacy row has no verified publisher-origin assessment."},"editorialMarket":{"status":"unknown","value":null,"confidence":null,"method":"unavailable","evidence":[],"reason":"Legacy row has no verified primary editorial-market assessment; superseded fields are not reinterpreted."},"framing":{"status":"unknown","value":null,"confidence":null,"method":"unavailable","evidence":[],"reason":"Legacy row has no evidence-backed framing assessment."},"tone":{"status":"unknown","value":null,"confidence":null,"method":"unavailable","evidence":[],"reason":"Legacy row has no evidence-backed tone assessment."}}';
